...
writer.print("<html><head>"+"<title>CookieInfo</title>" +"<style>"+styles.toString()+"</style>" +"</head><body>"
+ PreferenceServlet.MENU +"<div class='title'>" +"Session Management with Cookies:</div>");

writer.print("<div class='title'>");
//cookies will be null if there's no cookie/
if(cookies==null){

    writer.print("No cookie in this HTTPresponse");
}else
{writer.println("Cookies in this HTTP response");
}
for (Cookie cookie:cookies){
