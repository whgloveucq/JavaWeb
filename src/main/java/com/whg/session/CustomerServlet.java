...
import com.whg.session.Customer;
...
public class CustomerServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = -2915255510324265832L;
...
if(customer!=null){
    writer.println("<html><head>"+"<title>EditCustomer</title></head>"+"<body><h2>Edit Customer</h2>"+
